define(['./../../shared/site_request','./../../shared/api_request','models/player'],function(SiteRequest,ApiRequest,Player){
	var Clan = Class.extend({
	    ...
	    loadInfo: function(){
	    	...
	    	var self = this,
	    		src = WOT_MEDIA_BASE+"media/clans/emblems/cl_"+WID.toString().slice(-3)+"/"+WID+"/emblem_64x64.png";
	    ...
	    loadPlayers: function(force,retry){
			...
			var self = this,
				src = WOT_MEDIA_BASE+"media/clans/emblems/clans_"+WID.toString().charAt(0)+"/"+WID+"/emblem_64x64.png";
